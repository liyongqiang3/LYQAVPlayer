//
//  TYVideoDiskCacheProtocol.h
//  Pods
//
//  Created by yongqiang li on 2018/9/14.
//

#ifndef TYVideoDiskCacheProtocol_h
#define TYVideoDiskCacheProtocol_h

@protocol TYVideoDiskCacheProtocol <NSObject>
...
#endif /* TYVideoDiskCacheProtocol_h */
